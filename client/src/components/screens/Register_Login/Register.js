                ...
                :
                    <View>
                        ...
                        <View style={styles.tnc}>
                            <TouchableOpacity>
                                <Text style={styles.close} onPress={closeTc} > <Icon style={styles.close} name="closecircleo" color="#D63031" /> Close</Text>
                            </TouchableOpacity>
                            ...
                            We cordially welcome you to Our <Text style={styles.dark}>SUKLAPA SEVA</Text> Mobile App We would need you co-operation at most to achive our goal.</Text>
